...
Route::get('/forgot-password', 'Auth\RecoverPasswordController@showForgotPasswordForm')->name('password.request');
Route::post('/reset-password', 'Auth\RecoverPasswordController@forgotPassword')->name('password.email');
Route::get('/recover-password/{token}', 'Auth\RecoverPasswordController@showRecoverPasswordForm')->name('password.reset');
Route::post('/recover-password', 'Auth\RecoverPasswordController@recoverPassword')->name('password.update');
